...
3) `npm run scrape` yap
4) `automation/scrape-pages/.generated/site` yolunda `index.html`'i aç (Live server ile açmalısın! VSC eklentisi: [VSC Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) ) 